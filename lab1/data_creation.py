...
y_sin =  ((10*np.cos(x_sin))**2 \
         + (10*np.sin(x_sin) - 10*3)**2)**0.5 #примерный модуль скорости полета при параболическом движении
                                                #под углом x_sin радиан с начальной скоростью 10 после 3 секунд
