...
np.savetxt('train/1_std.csv', lin_tr_std, delimiter=',')
np.savetxt('test/1_std.csv', lin_ts_std, delimiter=',')

std_tr_2 = scaler.fit_transform(df_2_tr[['Время']])
std_ts_2 = scaler.fit_transform(df_2_ts[['Время']])
np.savetxt('train/2_std.csv', lin_tr_std, delimiter=',')
np.savetxt('test/2_std.csv', lin_ts_std, delimiter=',')
